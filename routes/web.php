...
//search foundation
Route::get('search-foundation', 'FoundationSearchController@index')->middleware("FrontAccess");
Route::get('autocomplete', 'FoundationSearchController@autocomplete');
Route::get('advance-search', 'FoundationSearchController@advanceSearch')->middleware("FrontAccess");
...
Route::get('advanceSearchdata', 'FoundationSearchController@advanceSearchdata')->middleware("FrontAccess");
