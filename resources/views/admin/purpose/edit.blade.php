  ...
  <div class="row">
    <div class="col-lg-12">
      ...
      <div class="card">
		...
		{!! Form::open(array('route' => array('admin.purpose.update', $purposeuser->id))) !!}
          ...
          <div class="form-group row">
				...
				<div class="col-lg-6">
					...
					<div class="col-lg-12">				  
					  {!! Form::text('purpose', $purposeuser->purpose, ['class' => 'form-control','readonly']) !!}
					</div>
					<div class="col-lg-4">
					  {!! Form::label('Form', __( 'Form' ) . '', [ 'class' => 'col-form-label']) !!}
					</div>
					<div class="col-lg-12">				  
					  {!! Form::select('formid[]', $form,$formids, ['class' => 'form-control' ,'multiple']) !!}
					</div>					
					<div class="col-lg-4">
					  {!! Form::label('Hitlist', __( 'Hitlist' ).'', [ 'class' => 'col-form-label']) !!}
					</div>
					<div class="col-lg-12">
					   {!! Form::select('hitlist[]', $hitlist,$hitlistids, ['class' => 'form-control' ,'multiple']) !!}
					</div>
				</div>
				...
				<div class="col-lg-6">
					...
					<div class="col-lg-12">				  
						<select class="form-control" name="autoproductid">
							...
							<option value="{{$Products->id}}" @if($Products->id == $purposeuser->autoproductid) selected @endif>{{$Products->productname}} ({{$Products->price}}) </option>
							@endforeach
						</select>
					...
					<div class="col-lg-12">
					   <select class="form-control" name="coustomproductid">
							...
							<option value="{{$Products->id}}" @if($Products->id == $purposeuser->coustomproductid) selected @endif>{{$Products->productname}} ({{$Products->price}}) </option>
							@endforeach
						</select>
					</div>
					<div class="col-lg-8">
					...
					<div class="col-lg-12">
					   {!! Form::select('purposeid[]', $purpose,$purposeids, ['class' => 'form-control' ,'multiple']) !!}
					</div>
				</div>
			...
			<div class="tab-content" id="myTabContent">
				<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
					<div class="form-group row">
						<div class="col-lg-6">
							...
							<div class="col-lg-12">
								{!! Form::text('description2', $purposeuser->description2, ['class' => 'form-control', '', 'placeholder' => __( '' ) ]); !!}
							</div>
						</div>
						<div class="col-lg-6">
							<div class="col-lg-4">
							...
							<div class="col-lg-12">
								@if($purposeuser->showseaechdesc2 == 1)
									{!! Form::checkbox('showseaechdesc2', '1', true); !!}
								@else
					...
					<div class="form-group row">
						<div class="col-lg-6">
							...
							<div class="col-lg-12">
								{!! Form::text('memberdescription2', $purposeuser->memberdescription2, ['class' => 'form-control', '', 'placeholder' => __( '' ) ]); !!}
							</div>
						</div>
						<div class="col-lg-6">
							<div class="col-lg-4">
							...
							<div class="col-lg-12">
								@if($purposeuser->showmemberdesc2 == 1)
									{!! Form::checkbox('showmemberdesc2', '1', true); !!}
								@else
				...
				<div class="form-group row">
						<div class="col-lg-6">
							...
							<div class="col-lg-12">
								{!! Form::text('description1', $purposeuser->description1, ['class' => 'form-control', '', 'placeholder' => __( '' ) ]); !!}
							</div>
						</div>
						<div class="col-lg-6">
							<div class="col-lg-4">
							...
							<div class="col-lg-12">
								@if($purposeuser->showseaechdesc1 == 1)
									{!! Form::checkbox('showseaechdesc1', '1', true); !!}
								@else
					...
					<div class="form-group row">
						<div class="col-lg-6">
							...
							<div class="col-lg-12">
								{!! Form::text('memberdescription1', $purposeuser->memberdescription1, ['class' => 'form-control', '', 'placeholder' => __( '' ) ]); !!}
							</div>
						</div>
						<div class="col-lg-6">
							<div class="col-lg-4">
							...
							<div class="col-lg-12">
								@if($purposeuser->showmemberdesc1 == 1)
									{!! Form::checkbox('showmemberdesc1', '1', true); !!}
								@else
