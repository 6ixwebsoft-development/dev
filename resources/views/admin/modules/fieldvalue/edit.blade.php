	...
	<div class="col-lg-12">
		<div class="card">
			<div class="card-body">
				...
				<!--row-->
				<hr>
				{!! Form::open(array('route' => array('admin.modules.fieldvalue.update', $moduleFieldValue->id))) !!}
					...
					<div class="form-group row">
						...
						<div class="col-lg-10">
							{!! Form::select('field_id', $module_field_arr , '' , ['class' => 'form-control']); !!}
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-lg-10">
							{!! Form::text('value', $moduleFieldValue->value, ['class' => 'form-control', '', 'placeholder' => __( 'Field Value' ) ]); !!}
						</div>
					</div>
