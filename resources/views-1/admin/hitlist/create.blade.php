    ...
    <div class="col-lg-12">
      ...
      <div class="card">
        ...
        <div class="card-body">
         ...
         {!! Form::open(array('url' => 'admin/hitlist/store')) !!}
          ...
          <div class="form-group row">
				<div class="col-lg-6">
					...
					<div class="col-lg-12">				  
					  {!! Form::select('lenguage', $language,[], ['class' => 'form-control']) !!}
			 ...
			 <div class="form-group row">
				<div class="col-lg-6">
					...
					<div class="col-lg-12">				  
					   {!! Form::text('keyword', null, ['class' => 'form-control', '', 'placeholder' => __( 'Enter Keyword' ) ]); !!}
