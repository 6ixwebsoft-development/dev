    ...
    <div class="col-lg-12">
      ...
      <div class="card">
        ...
        <div class="card-body">
         ...
         {!! Form::open(array('url' => 'admin/subscriptiontype/store')) !!}
		  ...
		  <div class="form-group row">
				...
				<div class="col-lg-6">
					...
					<div class="col-lg-12">
					 ...
					 {!! Form::select('usertype', (['IND' => 'IND','LIB' => 'LIB','ORG' => 'ORG',]),[], ['class' => 'form-control','' ]  ); !!}
				...
				<div class="col-lg-6">
					...
					<div class="col-lg-12">
					  ...
					  {!! Form::select('duration', array('1' =>'1','2'=>'2','3' =>'3','4'=>'4','6' =>'6','5'=>'5','7' =>'7','8'=>'8','9'=>'9','10' =>'10','11' =>'11','12'=>'12','13' =>'13','14'=>'14','15'=>'15','16' =>'16','17' =>'17','18'=>'18','19'=>'19','20' =>'20','21' =>'21','22'=>'22','23' => '23','24' => '24','25'=>'25','26'=>'26','27'=>'27','28'=>'28','29'=>'29','30'=>'30','31'=>'31','32'=>'32','33'=>'33','34'=>'34','35'=>'35','36'=>'36'),null, ['class' => 'form-control','' ]  ); !!}
		  ...
		  <div class="form-group row">
				...
				<div class="col-lg-6">
					...
					<div class="col-lg-12">
					  ...
					  {!! Form::text('price', null, ['class' => 'form-control myprice', 'onkeypress'=>'getsubscriptiontotal();', 'placeholder' => __( '' ) ]); !!}
		  ...
		  <div class="form-group row">
				...
				<div class="col-lg-6">
					...
					<div class="col-lg-12">
					  ...
					  {!! Form::text('misc', null, ['class' => 'form-control mymisc', 'onkeypress'=>'getsubscriptiontotal();', 'placeholder' => __( '' ) ]); !!}
		...
		<div class="form-group row">
				...
				<div class="col-lg-6">
					...
					<div class="col-lg-12">
					  ...
					  {!! Form::text('vat', null, ['class' => 'form-control myvat','onkeypress'=>'getsubscriptiontotal();', 'placeholder' => __( 'Enter Discount Label' ) ]); !!}
				...
				<div class="col-lg-6">
					...
					<div class="col-lg-12">
					  ...
					  {!! Form::text('freightcharge', null, ['class' => 'form-control myfrch', 'onkeypress'=>'getsubscriptiontotal();', 'placeholder' => __( '' ) ]); !!}
			...
			<div class="form-group row">
				...
				<div class="col-lg-6">
					...
					<div class="col-lg-12">
					  ...
					  {!! Form::text('freighttax', null, ['class' => 'form-control myfrtx','onkeypress'=>'getsubscriptiontotal();', 'placeholder' => __( 'Enter VAT Label' ) ]); !!}
								  ...
								  <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
									<div class="form-group row">
										<div class="col-lg-6">
											...
											<div class="col-lg-12">
											  {!! Form::text('sv_name', null, ['class' => 'form-control','id'=>'','placeholder' => __( '' ) ]); !!}
											</div>
										</div>
										<div class="col-lg-6">
											<div class="col-lg-4">
											...
											<div class="col-lg-12">
											 {!! Form::textarea('sv_desc', null, ['class' => 'form-control','rows'=>'3','placeholder' => __( '' ) ]); !!}
											</div>
										</div>
									  </div>
								  </div>
								  <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
									<div class="form-group row">
										<div class="col-lg-6">
											...
											<div class="col-lg-12">
											  {!! Form::text('eng_name', null, ['class' => 'form-control','id'=>'','placeholder' => __( '' ) ]); !!}
											</div>
										</div>
										<div class="col-lg-6">
											<div class="col-lg-4">
											...
											<div class="col-lg-12">
											 {!! Form::textarea('eng_desc', null, ['class' => 'form-control','rows'=>'3','placeholder' => __( '' ) ]); !!}
											</div>
										</div>
									  </div>
								  </div>
