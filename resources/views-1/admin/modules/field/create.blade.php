	...
	<div class="col-lg-12">
		<div class="card">
			<div class="card-body">
				...
				<!--row-->
				<hr>
				{!! Form::open(array('url' => 'admin/modules/field/store')) !!}
					
					<div class="form-group row">
						<div class="col-lg-2">
							{!! Form::label('module', __( 'Module Name' ) . ':*') !!}
						</div>
						<div class="col-lg-10">
							{!! Form::select('module_id', $modules, '', ['class' => 'form-control']); !!}
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-lg-10">
							{!! Form::text('field_name', null, ['class' => 'form-control', '', 'placeholder' => __( 'Field Name' ) ]); !!}
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-lg-10">
							{!! Form::text('field_type', null, ['class' => 'form-control', '', 'placeholder' => __( 'Field Type' ) ]); !!}
						</div>
					</div>
